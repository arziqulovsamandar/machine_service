...
const create_activation_dto_1 = require("./dto/create-activation.dto");
let ActivationController = exports.ActivationController = class ActivationController {
    constructor(activationService) {
        this.activationService = activationService;
    }
    create(createActivationDto) { }
};
__decorate([
    (0, common_1.Post)(),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [create_activation_dto_1.CreateActivationDto]),
    __metadata("design:returntype", void 0)
], ActivationController.prototype, "create", null);
